...
impl Cpu {
    ...
    pub(super) fn opcode_0x34(&mut self) {
        alu_reg8!(self, alu::inc, [hl]);
    }

    /// DEC (HL)
    pub(super) fn opcode_0x35(&mut self) {
        alu_reg8!(self, alu::dec, [hl]);
    }
