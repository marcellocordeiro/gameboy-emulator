...
impl Cpu {
    ...
    pub(super) fn opcode_cb_0x00(&mut self) {
        alu_op_r8!(self, alu_rotate_left_through_carry, b);
    }

    /// RLC C
    pub(super) fn opcode_cb_0x01(&mut self) {
        alu_op_r8!(self, alu_rotate_left_through_carry, c);
    }

    /// RLC D
    pub(super) fn opcode_cb_0x02(&mut self) {
        alu_op_r8!(self, alu_rotate_left_through_carry, d);
    }

    /// RLC E
    pub(super) fn opcode_cb_0x03(&mut self) {
        alu_op_r8!(self, alu_rotate_left_through_carry, e);
    }

    /// RLC H
    pub(super) fn opcode_cb_0x04(&mut self) {
        alu_op_r8!(self, alu_rotate_left_through_carry, h);
    }

    /// RLC L
    pub(super) fn opcode_cb_0x05(&mut self) {
        alu_op_r8!(self, alu_rotate_left_through_carry, l);
    }

    /// RLC (HL)
    pub(super) fn opcode_cb_0x06(&mut self) {
        alu_op_hl!(self, alu_rotate_left_through_carry, (hl));
    }

    /// RLC A
    pub(super) fn opcode_cb_0x07(&mut self) {
        alu_op_r8!(self, alu_rotate_left_through_carry, a);
    }

    /// RRC B
    pub(super) fn opcode_cb_0x08(&mut self) {
        alu_op_r8!(self, alu_rotate_right_through_carry, b);
    }

    /// RRC C
    pub(super) fn opcode_cb_0x09(&mut self) {
        alu_op_r8!(self, alu_rotate_right_through_carry, c);
    }

    /// RRC D
    pub(super) fn opcode_cb_0x0a(&mut self) {
        alu_op_r8!(self, alu_rotate_right_through_carry, d);
    }

    /// RRC E
    pub(super) fn opcode_cb_0x0b(&mut self) {
        alu_op_r8!(self, alu_rotate_right_through_carry, e);
    }

    /// RRC H
    pub(super) fn opcode_cb_0x0c(&mut self) {
        alu_op_r8!(self, alu_rotate_right_through_carry, h);
    }

    /// RRC L
    pub(super) fn opcode_cb_0x0d(&mut self) {
        alu_op_r8!(self, alu_rotate_right_through_carry, l);
    }

    /// RRC (HL)
    pub(super) fn opcode_cb_0x0e(&mut self) {
        alu_op_hl!(self, alu_rotate_right_through_carry, (hl));
    }

    /// RRC A
    pub(super) fn opcode_cb_0x0f(&mut self) {
        alu_op_r8!(self, alu_rotate_right_through_carry, a);
    }

    /// RL B
    pub(super) fn opcode_cb_0x10(&mut self) {
        alu_op_r8!(self, alu_rotate_left, b);
    }

    /// RL C
    pub(super) fn opcode_cb_0x11(&mut self) {
        alu_op_r8!(self, alu_rotate_left, c);
    }

    /// RL D
    pub(super) fn opcode_cb_0x12(&mut self) {
        alu_op_r8!(self, alu_rotate_left, d);
    }

    /// RL E
    pub(super) fn opcode_cb_0x13(&mut self) {
        alu_op_r8!(self, alu_rotate_left, e);
    }

    /// RL H
    pub(super) fn opcode_cb_0x14(&mut self) {
        alu_op_r8!(self, alu_rotate_left, h);
    }

    /// RL L
    pub(super) fn opcode_cb_0x15(&mut self) {
        alu_op_r8!(self, alu_rotate_left, l);
    }

    /// RL (HL)
    pub(super) fn opcode_cb_0x16(&mut self) {
        alu_op_hl!(self, alu_rotate_left, (hl));
    }

    /// RL A
    pub(super) fn opcode_cb_0x17(&mut self) {
        alu_op_r8!(self, alu_rotate_left, a);
    }

    /// RR B
    pub(super) fn opcode_cb_0x18(&mut self) {
        alu_op_r8!(self, alu_rotate_right, b);
    }

    /// RR C
    pub(super) fn opcode_cb_0x19(&mut self) {
        alu_op_r8!(self, alu_rotate_right, c);
    }

    /// RR D
    pub(super) fn opcode_cb_0x1a(&mut self) {
        alu_op_r8!(self, alu_rotate_right, d);
    }

    /// RR E
    pub(super) fn opcode_cb_0x1b(&mut self) {
        alu_op_r8!(self, alu_rotate_right, e);
    }

    /// RR H
    pub(super) fn opcode_cb_0x1c(&mut self) {
        alu_op_r8!(self, alu_rotate_right, h);
    }

    /// RR L
    pub(super) fn opcode_cb_0x1d(&mut self) {
        alu_op_r8!(self, alu_rotate_right, l);
    }

    /// RR (HL)
    pub(super) fn opcode_cb_0x1e(&mut self) {
        alu_op_hl!(self, alu_rotate_right, (hl));
    }

    /// RR A
    pub(super) fn opcode_cb_0x1f(&mut self) {
        alu_op_r8!(self, alu_rotate_right, a);
    }
    ...
    pub(super) fn opcode_cb_0x30(&mut self) {
        alu_op_r8!(self, alu_swap_nibbles, b);
    }

    /// SWAP C
    pub(super) fn opcode_cb_0x31(&mut self) {
        alu_op_r8!(self, alu_swap_nibbles, c);
    }

    /// SWAP D
    pub(super) fn opcode_cb_0x32(&mut self) {
        alu_op_r8!(self, alu_swap_nibbles, d);
    }

    /// SWAP E
    pub(super) fn opcode_cb_0x33(&mut self) {
        alu_op_r8!(self, alu_swap_nibbles, e);
    }

    /// SWAP H
    pub(super) fn opcode_cb_0x34(&mut self) {
        alu_op_r8!(self, alu_swap_nibbles, h);
    }

    /// SWAP L
    pub(super) fn opcode_cb_0x35(&mut self) {
        alu_op_r8!(self, alu_swap_nibbles, l);
    }

    /// SWAP (HL)
    pub(super) fn opcode_cb_0x36(&mut self) {
        alu_op_hl!(self, alu_swap_nibbles, (hl));
    }

    /// SWAP A
    pub(super) fn opcode_cb_0x37(&mut self) {
        alu_op_r8!(self, alu_swap_nibbles, a);
    }
